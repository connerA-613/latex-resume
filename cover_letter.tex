...
\recipient{Ms. Amanda Westenberg}{ PureFacts Financial Solutions Inc.\\372 Bay St Suite 1703\\Toronto, ON M5H 2W9} % The company being applied to

\letterdate{\today} % The date on the letter, default is the date of compilation

\lettertitle{Job Application for Junior Software Engineer position} % The title of the letter
